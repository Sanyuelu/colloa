...
public class EmployeeInfo {
    ...
    public String getAcademicRef() {
        return academicRef;
    }

    public void setAcademicRef(String academicRef) {
        this.academicRef = academicRef == null ? null : academicRef.trim();
    }
